...
class AssistantActionService:
    """Validate, authorize, and audit requests without enabling executors."""
    ...
    async def evaluate_request(
        ...
        *,
        ...
        """Evaluate and audit a typed request without performing desktop work."""
        ...
        if decision is PermissionDecision.MISSING:
            ...
            result = ActionResult(
                ...
                summary="Desktop action executors are not enabled in Phase 8A.",
                permission_decision=decision,
