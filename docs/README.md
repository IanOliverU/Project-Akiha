...
| 9 - Pet Simulation | Planned | [`phases/phase-09-pet-sim/`](phases/phase-09-pet-sim/) |
...
- [`roadmap/VOICE_INTELLIGENCE_V0_V8.md`](roadmap/VOICE_INTELLIGENCE_V0_V8.md)
  ...
  Intelligence. V0 through V6 and V7A-V7E are complete; V7F deterministic and
  constrained JSON fallback hardening is next.
