...
than an installer. The V5 Modular Voice Intelligence candidate retains that
decision.
...
The current verified candidate package is:

```text
dist\nuitka-v5-local-voice-final\main.dist\
```
