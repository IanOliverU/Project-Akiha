...
- Build workflow, dependency groups, supported Python notes, quality gate,
  ...
  in `docs/phases/phase-06-packaging/BUILD_RELEASE.md`.
...
- Distribution behavior and future installer backlog are documented in
  `docs/phases/phase-06-packaging/DISTRIBUTION_DECISION.md`.
- Draft release notes for the first standalone package are in
  `docs/phases/phase-06-packaging/RELEASE_NOTES_DRAFT.md`.
...
- Phase 6 security posture and deferred public-distribution items are documented
  in `docs/reference/SECURITY_REVIEW.md`.
...
- Build workflow is documented in
  `docs/phases/phase-06-packaging/BUILD_RELEASE.md`.
- Local data and reset behavior are documented in
  `docs/reference/LOCAL_DATA_PRIVACY.md`.
- Distribution behavior is documented in
  `docs/phases/phase-06-packaging/DISTRIBUTION_DECISION.md`.
- Security posture is documented in `docs/reference/SECURITY_REVIEW.md`.
- Deferred ideas are organized in `docs/roadmap/PROJECT_BACKLOG.md`.
- Manual packaged smoke is documented in
  `docs/phases/phase-06-packaging/MANUAL_PACKAGED_SMOKE.md`.
- Manual smoke reports can be created from
  `docs/phases/phase-06-packaging/MANUAL_SMOKE_REPORT_TEMPLATE.md` with
  `scripts/new_manual_smoke_report.ps1`.
- Draft release notes are documented in
  `docs/phases/phase-06-packaging/RELEASE_NOTES_DRAFT.md`.
...
ideas are organized in `docs/roadmap/PROJECT_BACKLOG.md`.
